...
if __name__ == "__main__":
    ...
    df_master = pd.concat([df_exp1, df_exp2, df_exp3], ignore_index=True)
    ...
    exp1_2_expected = 3 * 2 * 3 * 2 * 2  # 72 runs each (Seeds * Pools * Shifts * Batches * HiddenDims)
    exp3_expected = 4 * 1 * 5 * 1 * 1    # 20 runs (4 Seeds * 1 Pool * 5 Shifts * 1 Batch * 1 HiddenDim)
    total_expected_runs = (exp1_2_expected * 2) + exp3_expected # 144 + 20 = 164
    ...
    print(f"Expected Unique Runs: {total_expected_runs} (72 for Exp1/2, 20 for Exp3)")
